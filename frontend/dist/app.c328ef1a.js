...
var tvOptions = ["LED", "LCD", "OLED"];
var laptopOptions = ["Intel", "AMD"];
var shoeOptions = ["Piel", "Plástico"];
...
document.getElementById("categorySelector").addEventListener("change", /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(event) {
    var selectedCategory, array, i, newOption;
        ...
        switch (_context.prev = _context.next) {
          case 0:
            ...
            for (i = 0; i < array.length; i++) {
              newOption = new Option(array[i], array[i]);
...
var removeOptions = function removeOptions() {
  var index = optionsDD.options.length;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.prev = 0;
            _context2.next = 3;
            return _axios.default.get("".concat(BASE_URL, "/getAllItems"));
...
var refreshItems = function refreshItems(items) {
...
var createElement = function createElement(item) {
  ...
  row.className = "row";
  row.id = item._id;
  var cellClassName = "col py-2 cell";
  ...
  var divEl7 = document.createElement("div");
  ...
  deleteButton.onclick = /*#__PURE__*/function () {
      ...
      return _regeneratorRuntime().wrap(function _callee3$(_context3) {
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              _context3.next = 2;
              return deleteItem(event.target.value);
  ...
  var divEl8 = document.createElement("div");
...
var getCostByCategory = function getCostByCategory(category, cost) {
  var percentage = 0;
...
form.addEventListener("submit", /*#__PURE__*/function () {
  var _ref5 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(event) {
    var name, sku, brand, cost, category, item_type, item_value, item, submitItem;
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            ...
            item_type = document.querySelector("#optionsDD").value;
            item_value = document.querySelector("#itemValue").value;
            item = {
              name: name,
              sku: sku,
              brand: brand,
      ...
      while (1) {
        switch (_context6.prev = _context6.next) {
          case 0:
            _context6.prev = 0;
            _context6.next = 3;
            return _axios.default.post("".concat(BASE_URL, "/addNewItem"), item);
...
var deleteItem = /*#__PURE__*/function () {
  var _ref7 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee7(itemId) {
    var response, deleteResponse, row;
      ...
      while (1) {
        switch (_context7.prev = _context7.next) {
          case 0:
            _context7.prev = 0;
            _context7.next = 3;
            return _axios.default.delete("".concat(BASE_URL, "/deleteItem/").concat(itemId));

          case 3:
            response = _context7.sent;
            deleteResponse = response.data;
            row = document.getElementById(deleteResponse._id);
            row.remove();
            _context7.next = 12;
            break;
  ...
  return function deleteItem(_x5) {
